...
STM32F103RGT6 generic board. This "generic" configuration is not very usable
out-of-box, but can be used as a starting point to creating new configs with
similar STM32 high-density value line chips. 
...
========
  ...
  - LEDs
  - UARTs
  - "STMicro STM32F103RGT6 generic" specific Configuration Options
  - Configurations
...
It is asumed that STMicro STM32F103RGT6 generic board board has one LED on PC8.
You should configure the port and pin number in
configs/stm32f100rc_generic/src/stm32f103rgt6_internal.h. This LED is not used by
...
============================================================
    ...
    CONFIG_ARCH_CHIP_name - For use in C code to identify the exact
       ...
       CONFIG_ARCH_CHIP_STM32F103RGT6=y
    ...
    CONFIG_ARCH_BOARD - Identifies the configs subdirectory and
       ...
       CONFIG_ARCH_BOARD=stm32f103rgt6_generic

    CONFIG_ARCH_BOARD_name - For use in C code

       CONFIG_ARCH_BOARD_STM32F103RGT6_GENERIC=y
...
Each STMicro STM32F103RGT6 generic configuration is maintained in a sub-directory
and can be selected as follow:

    cd tools
    ./configure.sh stm32f103rgt6_generic/<subdir>
    cd -
    . ./setenv.sh
...
ST-Link USB Storage quick
==========================

Create /etc/modprobe.d/stlink.conf with following contents:

options usb-storage quirks=483:3744:i

Quick solution 

echo "options usb-storage quirks=483:3744:i" > /etc/modprobe.d/stlink.conf
